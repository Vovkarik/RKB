...
<html lang="en">
  <head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Caesar+Dressing|Open+Sans|Roboto+Condensed&display=swap" rel="stylesheet">
      <?php wp_head(); ?>
  </head>
  <body>
    <div class="b-header">
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-3 col-md-7 col-lg-7 col-xl-7">
            <nav class="navbar navbar-expand-md navbar-light">
              <button class="b-header__burger navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
              </button>
              <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav b-header__menu">
                  <li class="nav-item dropdown b-header__item">
                    <a class="dropdown-toggle" href="/about-rkb" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      О РКБ
                    </a>
